...
func (m *SecurityModel) Get(id uint64) (*models.Security, error) {
	s := &models.Security{}
	...
	row = m.DB.QueryRow(GetBestPrice, dt.IsoFormat(date), id)
...
func (m *SecurityModel) Insert(symbol string, name string) (uint64, error) {
